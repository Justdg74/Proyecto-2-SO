...
//            Global.getCN().getPrioridad3().imprimir();
    ...
    public void changeIcons(){
        //interfaz.getCharacter_Icon_SW().setIcon(new ImageIcon(getClass().getResource("/InterfaceImages/"+this.ai.getP2().getName()+".png")));
        //interfaz.getCharacter_Icon_Cn().setIcon(new ImageIcon(getClass().getResource("/InterfaceImages/"+this.ai.getP1().getName()+".png")));
    }
